...
// Jobs
def enableCompMan = freeStyleJob(projectFolderName + "/Features to Enable" + "/Enable_Compensation_Management")

//Pipeline
def enableCompManPipe = buildPipelineView(projectFolderName + "/Features to Enable" + "/Enable_Compensation_Management")

//Configurations
enableCompManPipe.with{
    title('Enable_Compensation_Management')
    displayedBuilds(5)
    selectedJob(projectFolderName + "/Features to Enable" + "/Enable_Compensation_Management")
